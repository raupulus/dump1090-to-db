...
- **Conversión de tasas negativas:** `feetToMeters` convierte tanto ascensos positivos como descensos negativos dividiendo entre 3.281, asegurando que valores de descenso (ej. `-1408` ft/min) se conviertan fielmente a metros.
